...
struct EditPaymentCardView: View {
    
    let card: PaymentCard
    
    @Environment (\.presentationMode) var presentationMode
    @StateObject private var vm = EditPaymentCardViewModel()
    ...
    var body: some View {
        ...
        .navigationTitle("Edit   Payment Card")
    }
}

struct EditPaymentCardView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationView {
            EditPaymentCardView(card: MockCard.mockPaymentCard)
        }
    }
}
